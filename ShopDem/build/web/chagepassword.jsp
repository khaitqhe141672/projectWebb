<%-- 
    ...
    Created on : Mar 14, 2021, 2:49:43 PM
    Author     : Admin
--%>
                    ...
                    <div class="login-panel">
                        ...
                        <form action="changepass" method="post">
                            <div class="form-group">
                                <input type="email" class="form-control" value="${email}"readonly name="email">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Nhập mật khẩu mới" name="password">
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control" placeholder="Nhập laị mật khẩu mới" name="passwordc">
                            </div>
                            <div class="form-group">
                                <div class="col">
                                    <button type="submit" class="btn btn-sm">
                                        <i class="fas fa-sign-in-alt mr-1"></i> Đổi mật khẩu
                                    </button>
                                </div>
                            </div>
