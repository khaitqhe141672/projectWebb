<%-- 
    ...
    Created on : Mar 26, 2021, 2:20:20 AM
                                                ...
                                                <c:forEach items="${requestScope.listOrder}" var="ls" varStatus="s">
                                                    <c:if test="${ls.status == 3}">
                                                        ...
                                                        <td style="text-align: center;">
                                                            <c:if test="${ls.status == 3}">
                                                                <button type="button" class="btn btn-success br" data-toggle="tooltip" data-placement="right" title="Giao hàng thành công"></button>
                                                            </c:if>
                                                        </td>
                                                        <td ><a  href="details-history?id=${ls.id}" class="btn btn-warning">Chi tiết</a></td>
                                                        </tr>
                                                    </c:if>
                                                </c:forEach>
                                            </c:if>
